package rfm.com.data.db.user

import rfm.com.data.db.event.EventAttendeeTable
import rfm.com.data.db.event.EventTable
import rfm.com.data.db.event.toEvent
import rfm.com.security.token.*
...
class UserRepositoryImpl (
    ...
    override suspend fun getUserProfile(userId: Int): UserProfile? = suspendTransaction {
        try {
            ...
            val waitingListEvents = emptyList<rfm.com.data.db.event.Event>()
