<script>
    ...
    onMount(async () => {
        try {
            ...
            const response = await api.get('/api/kids-services');
...
{:else if kidsServices.length === 0}
    <Card>
        <div class="p-6 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">There are no kids services available to manage attendance.</p>
        </div>
    </Card>
{:else}
            ...
            <Card>
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-2">
                        <span class="font-medium">Age Group:</span> {service.ageGroup || 'N/A'}
                    </p>
