...
const KidsServiceAttendancePage: React.FC = () => {
  ...
  const statusCounts = {
    ...
    arrived: attendanceRecords.filter(r => r.status === AttendanceStatus.CHECKED_IN).length,
    pickedUp: attendanceRecords.filter(r => r.status === AttendanceStatus.CHECKED_OUT).length,
    absent: attendanceRecords.filter(r => r.status === AttendanceStatus.NO_SHOW).length,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Statistics Cards - Kids Service Specific Labels */}
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <Card className="p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">{statusCounts.pickedUp}</div>
      ...
      {/* Special Notice for Kids Service */}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value={AttendanceStatus.CHECKED_OUT}>Picked Up</option>
              <option value={AttendanceStatus.NO_SHOW}>Absent</option>
          ...
          <EmptyState
            ...
            description={
              searchTerm || filterStatus !== 'all'
                ...
                : "No kids service attendance records have been created yet"
            }
...
export default KidsServiceAttendancePage;